...
{$ENDIF}
  ...
  public
    ...
    function ShowBalloonHint(Title, Text: widestring; IconType: TBalloonHintIcon;
...
function TCoolTrayIcon.ShowBalloonHint(Title, Text: widestring;
