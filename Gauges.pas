...
{ This function solves for y in the eq
...
function TGauge.GetPercentDone: int64;
...
int64(Round(MiddleX * (1 - Cos(Angle)))),

int64(Round(MiddleY * (1 - Sin(Angle)))), MiddleX, 0);
...
LineTo(int64(Round(MiddleX * (1 - Cos(Angle)))),

int64(Round((PaintRect.Bottom - 1) * (1 - Sin(Angle)))));
...
procedure TGauge.SetMinValue(Value: int64);
...
procedure TGauge.SetMaxValue(Value: int64);
...
procedure TGauge.SetProgress(Value: int64);
...
procedure TGauge.AddProgress(Value: int64);
